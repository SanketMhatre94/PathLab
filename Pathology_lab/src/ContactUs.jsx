      ...
      <div className="flex justify-center font-poppins items-center h-screen">
        <div className="flex flex-col md:flex-row  rounded-lg pl-8 pr-8 pb-8">
          ...
          <div className="md:w-[36rem] md:mt-0 mt-[18rem] md:pr-8 md:ml-[9rem]">
            ...
            <button className="bg-gradient-to-r from-teal-400 to-blue-500 text-white px-4 py-2 rounded-md hover:bg-[#46c79f]">Send</button>
          </div>

          {/* Right Side */}
          <div className="md:w-[23rem] md:h-[25rem] md:ml-[3rem] md:pl-8 md:mt-0 mt-8 bg-gradient-to-r from-teal-400 to-blue-500 text-white p-6 rounded">
            ...
            {/* <className="text-1xl  " /> */}
              <ImLocation2  className="text-white mr-2"/><span>CBD Belapur,Navi Mumbai, Maharashtra</span>
            </div>
          </div>
        </div>
      </div>
